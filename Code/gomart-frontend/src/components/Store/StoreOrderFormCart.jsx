...
const StoreOrderFormCart = () => {
  ...
  const [cartProduct, setCartProduct] = useState([]);
    ...
    const totalPrice = async () => {
        ...
        await axios.get("http://localhost:8000/api/customerCart/tot")
        .then(({ data }) => {
            var sum = 0;
  ...
  const onSubmit = (e) => {
    ...
    axios.delete(`http://localhost:8000/api/customerCart/deleteCart`);
        ...
        <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rs.{element.buyingQty * element.price}</td>
                        </tr>
                                )
                            })
                        } 
